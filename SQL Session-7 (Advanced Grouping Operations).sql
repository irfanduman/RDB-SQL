...
--(maximum list price'� 4000'in �zerinde olan veya minimum list price'� 500'�n alt�nda olan categori id' leri getiriniz - category name istenmiyor)
...
--(Markalara ait ortalama �r�n fiyatlar�n�, ortalama fiyatlara g�re azalan s�rayla g�steriniz)
...
--her sipari�in toplam net tutar�n� getiriniz. (m��terinin sipari� i�in �dedi�i tutar)
...
--1. Calculate the total sales price (toplam sat�� miktar�n� hesaplay�n�z)
...
--2. Calculate the total sales price of the brands (Markalar�n toplam sat�� miktar�n� hesaplay�n�z)
...
--3. Calculate the total sales price of the categories (Kategori baz�nda toplam sat�� miktar�n� hesaplay�n�z)
...
--4. Calculate the total sales price by brands and categories. (Marka ve kategori k�r�l�m�ndaki toplam sales miktar�n� hesaplay�n�z)
...
--(kategorilere ve model y�l�na g�re toplam �r�n say�s�n� summary tablosu �zerinden hesaplay�n)
			...
			--select c.category_name, p.model_year, COUNT(p.product_id)
