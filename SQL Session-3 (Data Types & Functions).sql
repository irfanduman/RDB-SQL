...
SELECT phone, email, ISNULL(phone, email) as contact_info
FROM sale.customer


SELECT phone, email, COALESCE(phone, email, street, city) as contact_info
FROM sale.customer
...
SELECT email, CHARINDEX('@', email) AS index_for_@,
